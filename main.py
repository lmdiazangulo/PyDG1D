...
import scipy.constants.speed_of_light as c0, \
       scipy.constants.epsilon_0 as eps0, \
       scipy.constants.mu_0 as mu0
...
x = dg.meshGrid(D,N,vx) # x    := Nodes in equispaced positions.

# ============== Initializing solver ==========================================
massMatrix = dg.massMatrix(D,N) # General Mass Matrix for that order.
